/**
 * Per-run Supabase client for the cloud Mastra memory adapter.
 *
 ...
 * the SECURITY DEFINER RPCs. The JWT scopes every request to the
...
/** Resolve the baked Supabase URL (publishable). Baked into main's `define` at
 *  build; otherwise read from the runtime env. */
