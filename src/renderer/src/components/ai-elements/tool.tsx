...
const JsonBlock = ({ code }: { code: string }) => (
  <CodeBlock className="group/cb" code={code} language="json">
    <CodeBlockCopyButton className="absolute top-1.5 right-1.5 z-10 size-7 opacity-0 transition-opacity group-hover/cb:opacity-100 focus-visible:opacity-100" />
  </CodeBlock>
);
...
export const ToolOutput = ({ className, output, errorText, ...props }: ToolOutputProps) => {
  ...
  return (
    <div className={cn("space-y-2", className)} {...props}>
      ...
      <div
        className={cn(
          "max-h-64 overflow-auto rounded-md text-xs [&_table]:w-full",
